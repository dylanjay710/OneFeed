...
public class UserProfile extends AppCompatActivity implements GoogleApiClient.OnConnectionFailedListener, View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.google_provided_button).setOnClickListener(this);
//        findViewById(R.id.google_provided_signout).setOnClickListener(this);
        ...
        SignInButton signInButton = (SignInButton) findViewById(R.id.google_provided_button);
    ...
    private void updateUI(boolean signedIn) {
        if (signedIn) {
            findViewById(R.id.google_provided_button).setVisibility(View.GONE);
//            findViewById(R.id.sign_out_and_disconnect).setVisibility(View.VISIBLE);
        } else {
//            mStatusTextView.setText(R.string.signed_out);

//            findViewById(R.id.google_provided_button).setVisibility(View.VISIBLE);
//            findViewById(R.id.sign_out_and_disconnect).setVisibility(View.GONE);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.google_provided_button:
                signIn();
                break;
